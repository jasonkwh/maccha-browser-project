...
[Try the Free Demo (based on Build 221)](https://appetize.io/app/nr3f5r36mf5wuz2a1a5qkeb68m)
...
You can install CocoaPods with [RubyGems](https://rubygems.org/) by using the following command:
